...
//    ),
  ...
  static List<SettingsListData> helpSearchList = [
    SettingsListData(
      titleTxt: 'Membership Related Questions',
      subTxt: "",
    ),
    SettingsListData(
      titleTxt: '',
      subTxt: "Why are flights the cheapest on FlyLine?",
    ),
    SettingsListData(
      titleTxt: '',
      subTxt: "Why do I need a membership to purchase a flight on FlyLine?",
    ),
    SettingsListData(
      titleTxt: '',
      subTxt: "What is FlyLine’s flight purchase refund policy?",
    ),
    SettingsListData(
      titleTxt: '',
      subTxt: "What is virtual interlining?",
    ),
    SettingsListData(
  ...
  static List<SettingsListData> userInfoList = [
    ...
    SettingsListData(
      titleTxt: 'Email Address',
      subTxt: "zach@joinflyline.com",
    ),
    SettingsListData(
    ...
    SettingsListData(
      titleTxt: 'Passport Number',
      subTxt: "146792",
    ),
    SettingsListData(
      titleTxt: 'KnownTraveler Number',
      subTxt: "1784242",
    ),
  ];
}
