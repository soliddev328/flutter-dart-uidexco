...
// import 'package:motel/modules/home/guest_home.dart';
...
// //   Widget _showSendingProgressBar() {
// //     _searchProgressBar.show(context);
// //   }

// //   Widget _hideSendingProgressBar() {
// //     _searchProgressBar.hide();
// //   }
...
//               children: <Widget>[
//                 Container(
//                   margin: EdgeInsets.only(bottom: 10, top: spacing),
//                   child: Text(
//                     "Trip Date",
//                     style: TextStyle(
...
//                 ),
//                 Container(
//                   margin: EdgeInsets.only(top: spacing, bottom: 10),
//                   child: Row(
//                     mainAxisAlignment: MainAxisAlignment.spaceBetween,
//                     children: <Widget>[
//                       Expanded(
...
//                 ),
//                 Container(
//                   margin: EdgeInsets.only(top: spacing, bottom: 5),
//                   child: Text(
//                     "Cabin",
//                     style: TextStyle(
//                         fontWeight: FontWeight.normal,
...
//               //       });
//               return Container(
//                 child: Center(child: _showSendingProgressBar()
...
//             //       top: 15.0, right: 9.0, left: 9.0, bottom: 11.0),
//             //   child: Container(
//             //     decoration: BoxDecoration(
//             //         color: Colors.white,
...
//             //             children: <Widget>[
//             //               new Text(
//             //                 formatTime.format(departures[0].localDeparture) +
//             //                     ' - ' +
//             //                     formatTime.format(
...
//             //               new Text(
//             //                 formatTime.format(
//             //                     returns[returns.length - 1].localDeparture),
//             //                 style: TextStyle(
//             //                   fontFamily: 'Gilroy',
//             //                   color: Color(0xff000000),
//             //                   fontSize: 14,
...
//             return InkWell(
//                           child: Container(
//                 margin: EdgeInsets.only(left: 20, right: 20, top: 0, bottom: 16),
//                 decoration: BoxDecoration(
...
//                                   (a2b > 1
//                                       ?  getFlightDetailItemsLogos(departures)
//                                       : Expanded(
//                                           child:
//                                           Container(
//                                             decoration: BoxDecoration(
...
//                                     (a2b > 0
//                                         ? (a2b > 1
//                                             ? getFlightDetailItems(departures)
...
// //                   //             _clickFlight[index]
// //                   //         ? this
// //                   //             .getFlightDetailItems(departures, returns, flight)
// //                   //         : Container()),
// //                   // Container(
...
// //                         children: [
// //                           TextSpan(
// //                             text: formatDates.format(flight.localDeparture) + ' - ',
// //                             style: TextStyle(
// //                               fontFamily: 'Gilroy',
// //                               color: Color(0xff3a3f5c),
// //                               fontSize: 14,
...
//                       TextSpan(
//                         text: formatDates
//                             .format(returns[returns.length - 1].localDeparture),
//                         style: TextStyle(
//                           fontFamily: 'Gilroy',
//                           color: Color(0xff3a3f5c),
//                           fontSize: 14,
...
// //                 left: screenWidth(context) / 3.5,
// //                 child: Material(color: Color(0xFF113377),
// //                   child: new Text(
