...
class PopularListView extends StatefulWidget {
  ...
  const PopularListView({Key key, this.callBack, this.animationController}) : super(key: key);
  @override
...
class CategoryView extends StatelessWidget {
  ...
  const CategoryView({Key key, this.popularList, this.animationController, this.animation, this.callback}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return AnimatedBuilder(
