...
import 'package:motel/modules/datepicker/classes/event_list.dart';
import 'package:motel/modules/datepicker/src/default_styles.dart';
import 'package:motel/modules/datepicker/src/calendar_header.dart';
import 'package:motel/modules/datepicker/src/weekday_row.dart';
import 'package:intl/date_symbol_data_local.dart';
import 'package:intl/intl.dart' show DateFormat;
export 'package:motel/modules/datepicker/classes/event_list.dart';
...
class _CalendarState<T extends EventInterface> extends State<CalendarCarousel<T>> {
  ...
  void _onDayPressed(DateTime picked) {
    print('onDayPressed:${picked.toString()}');
    ...
    bool shouldAdd=_selectedDate.length<2;
    for(int i=0;i<_selectedDate.length;i++){
    ...
    if(shouldAdd)
      setState(() {
        print('selectedDayAdded:${picked.toString()}');
